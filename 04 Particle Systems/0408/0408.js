...
function setup(context,canvas) {
	oPartSys = new ParticleSystem(new Vector2d(canvas.width/2,canvas.height/4));
		...
		(function init(){
			// initialize stuff here
			 ...
			 setup(context,canvas);
 			 ...
 			 oParticleImage = new Image();  
			 oParticleImage.src = 'blueParticle.png';
			 oParticleImage.onload = function()
			 {
