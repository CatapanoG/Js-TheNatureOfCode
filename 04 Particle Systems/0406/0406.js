...
//
// Exercise 4.8
// Create a particle system with different “kinds” of particles in the same system. 
// Try varying more than just the look of the particles. 
// How do you deal with different behaviors using inheritance?
//
...
var oPartSys, 
	v2Gravity = new Vector2d(0,0.04);

function setup(context,canvas) {
	oPartSys = new ParticleSystem(new Vector2d(canvas.width/2,canvas.height/2));
};
