...
//
// Exercise 4.2
// Add angular velocity (rotation) to the particle. 
// Create your own non-circle particle design.
//
...
function setup(context,canvas) {
	p = new Particle(new Vector2d(canvas.width/2,10));
};

function update(canvas){
	v2Wind = new Vector2d((Math.random()-0.5)/10,(Math.random()-0.5)/10);
	v2Gravity = new Vector2d(0,0.01);
	p.applyForce(v2Gravity);
	p.applyForce(v2Wind);
