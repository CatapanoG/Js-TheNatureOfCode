...
function ParticleRnd(v2Location) {
	Particle.call(this,v2Location);

	this.acceleration = new Vector2d(10,10);
};

ParticleRnd.prototype = Object.create(Particle.prototype);
ParticleRnd.prototype.update = function(){
...
ParticleRnd.prototype.display = function(context){
