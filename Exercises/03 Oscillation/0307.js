...
var oscillators = [],
	oscillatorsLength = 1000;

function setup(context,canvas) {

	var theta = 0,
		thetaMax = 10, // num of complete circles in the spiral
		r = 0,
	...
	for (var i = 0; i < oscillatorsLength; i++) {
		...
		r = (i+1)*(rMax/(oscillatorsLength-1));

		x = r*Math.cos(theta)/1000000;
		y = r*Math.sin(theta)/1000000;

		var angle = new Vector2d(0,0);
